...
import { Anchor, Board, Button } from "../components/Components"
                    ...
                    <div className="col-span-12">
                        <form onSubmit={handleSave} action="">
                            ...
                            <div className="mb-3 text-start flex gap-3">
                                ...
                                <Button onClick={handleChangePassword} className={'bg-yellow-300 hover:bg-yellow-200'}>Change password</Button>
                                <Anchor href={'/profile'} className={'bg-red-500 hover:bg-red-400'}>Back</Anchor>
                            </div>     
                        </form>
                    </div>
                </Board>
